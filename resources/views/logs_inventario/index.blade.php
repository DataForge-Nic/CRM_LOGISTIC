                            ...
                            <tr>
                                ...
                                <td style="min-width:260px;">
                                    ...
                                    @if($log->accion == 'crear')
                                        ...
                                        <button type="button" class="btn btn-inv-action btn-inv-view" data-bs-toggle="modal" data-bs-target="#detallePaqueteModal{{ $log->id }}" title="Ver detalles del paquete" style="background: #1A2E75; color: #fff;">
                                    ...
                                    @else
                                        ...
                                        <button type="button" class="btn btn-inv-action btn-inv-view" data-bs-toggle="modal" data-bs-target="#detalleEdicionModal{{ $log->id }}" title="Ver cambios del paquete" style="background: #1A2E75; color: #fff;">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <!-- Modal Detalle Edición -->
                                        <div class="modal fade" id="detalleEdicionModal{{ $log->id }}" tabindex="-1" aria-labelledby="detalleEdicionModalLabel{{ $log->id }}" aria-hidden="true">
                                          <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                              <div class="modal-header" style="background: linear-gradient(90deg, #1A2E75 0%, #5C6AC4 100%);">
                                                <h5 class="modal-title text-white" id="detalleEdicionModalLabel{{ $log->id }}"><i class="fas fa-edit me-2"></i>Cambios del Paquete</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                              </div>
                                              <div class="modal-body">
